...
def get_indicator_result()->int:
    ...
    if ind1==ind_on_color and ind2==ind_on_color:
        return 1
    elif ind1!=ind_on_color and ind2!=ind_on_color:
        return 4
    elif ind1==ind_on_color and ind2!=ind_on_color:
        return 2
    elif ind1!=ind_on_color and ind2==ind_on_color:
...
while True:
    if 'm' == input('激活本cmd窗口，鼠标放到【top_indicator】，输入“M”并回车记录该坐标\n'):
        ...
        ind_on_color=get_pixel_color_hex(coords['indicator1'][0], coords['indicator1'][1])
        break
while True:
